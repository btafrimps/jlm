    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                ...
                <h2>Column 1</h2>
                <iframe width="560" height="315" src="https://www.youtube.com/embed/Ab5FeNxXmVQ?si=rlQKylCNKiTCXPj5"
        ...
        <h2>Ingredients in The Sobolo Drinks</h2>
        ...
        <div class="image_container">
            <div class="row">
                ...
                <!--2nd ingredient-->
                <div class="col-md-2">
                    <img src="/images/hibiscus.jpg" class="habiscus">
                ...
                <!--4th incredient-->
                <div class="col-md-2">
                    <img src="/images/oranges.jpg" class="orange">
                    <p>Oranges<br>62cal/131grams</p>
                </div>

                <!--5th incredient-->
                <div class="col-md-2">
                    <img src="/images/pineapple.jpg" class="pineapple">
                    <p>Pineapple<br>50cal/100grams</p>
                </div>

                <!--6th incredient-->
                <div class="col-md-2">
                    <img src="/images/watermelon.jpg" class="watermelon">
                    <p>Watermelon<br>30cals/100grams</p>
                </div>
