...
<head>
    ...
    <title>African Cocktail- Recipes</title>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    ...
                    <img src="/jlm/images/zonkom drink.jpg" class="zonkom">
                ...
                <div class="col-md-4">
                    ...
                    <h4>African Cocktail Recipe</h4>
                    <a href="zonkom.php">Spicey millet drink</a>
            ...
            <div class="row">
                <div class="col-md-4">
                    <!-- Content for the first column -->  
                    <img src="/jlm/images/habiscus drink.jpg" class="habiscus">
                </div>

                <div class="col-md-4">
                    <!-- Content for the second column -->
                    <h4>African Cocktail Recipe</h4>
                    <a href="sobolo.php">Spicey Habiscus Drink </a>
                    <p> By Sweet Adjeley</p>
                </div>
            ...
            <div class="row">
                <div class="col-md-4">
                    <!-- Content for the first column -->
                    <img src="/jlm/images/rice drink.jpg" class="ricedrink">
                </div>

                <div class="col-md-4">
                    <!-- Content for the second column -->
                    <h4>African Cocktail Recipe</h4>
                    <a href="lamugee.php">Spicey Rice Drink </a>
                    <p> By Sweet Adjeley</p>
                </div>
