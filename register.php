...
<html lang="en">
  ...
  <body>
    <div id="form">
      ...
      <form name ="form" action = "register.php" method="post"> <!--Form sends data to signup.php using the POST method -->
        ...
        <i class="bi bi-file-lock2-fill"></i>
        <input type = "confirm password" id = "confirmpassword" name ="confirmpassword" placeholder = "Confirm Password" required><br><br>
